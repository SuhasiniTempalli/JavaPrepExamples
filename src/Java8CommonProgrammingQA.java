...
public class Java8CommonProgrammingQA {
    ...
    public static void main(String[] args) {
        ...
        List<Integer> names = studentList.stream().map(student -> student.getId()+1).sorted().collect(Collectors.toList());
        System.out.println("printing the result using map" +names);
